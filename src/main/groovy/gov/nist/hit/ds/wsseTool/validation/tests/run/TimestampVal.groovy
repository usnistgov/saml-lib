...
public class TimestampVal extends BaseVal {
	...
	public void uniqueId() {
		...
		assertTrue("timestamp does not have a valid Id attribute. Id should be declared in the http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd namespace", prefix != null)
